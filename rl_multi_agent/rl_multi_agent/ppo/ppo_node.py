...
class PPONode(Node):  # Renamed from ASVPPONode for generalization (Point 8)
    def __init__(self):
        ...
        self.declare_parameter('rollout_dir', os.path.expanduser('~/Desktop/RL_Rollouts'))
    ...
    def _find_and_load_best_model(self):
        ...
        common_paths = [
            os.path.expanduser("~/Desktop/RL_Rollouts/latest_model.zip"),
            os.path.expanduser("~/Desktop/RL_Rollouts/ppo_model_final.zip"),
            "./latest_model.zip",
            "./ppo_model.zip",

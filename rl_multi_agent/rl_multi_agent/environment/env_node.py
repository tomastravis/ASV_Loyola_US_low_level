...
from ..trajectory.parametrized_path import ParametrizedPath
...
class EnvironmentNode(Node):
    def __init__(self):
        ...
        self.path_marker_pub = self.create_publisher(Marker, '/environment/path_marker', qos_profile)
        self.centroid_marker_pub = self.create_publisher(Marker, '/environment/centroid_marker', qos_profile)

        # Boundary visualization publishers
        self.core_boundary_pub = self.create_publisher(Marker, '/environment/core_boundary', qos_profile)
        self.safety_boundary_pub = self.create_publisher(Marker, '/environment/safety_boundary', qos_profile)
        self.warning_boundary_pub = self.create_publisher(Marker, '/environment/warning_boundary', qos_profile)
        ...
        self.get_logger().info(f'Environment Node started with {self.num_agents} agents')

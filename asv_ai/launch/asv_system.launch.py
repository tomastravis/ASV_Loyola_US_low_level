...
def generate_launch_description():
    ...
    rollout_dir_arg = DeclareLaunchArgument(
        ...
        description='Directory to save/load PPO rollouts and models'
    )
    training_enabled_arg = DeclareLaunchArgument(
        'training_enabled', default_value='false',
        description='Enable PPO updates; false means visual evaluation/replay'
    )
    ...
    train_frequency_arg = DeclareLaunchArgument(
    ...
    training_mode_arg = DeclareLaunchArgument(
        ...
        description='Training mode: fast or debug'
    )
    ...
    ld.add_action(train_frequency_arg)
